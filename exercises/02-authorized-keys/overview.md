...
for you at `calm.team`. Try logging in as that user with
the supplied private key. Then add your personal public key to `authorized_keys`
Then, log off and try to log in using your own private key.
